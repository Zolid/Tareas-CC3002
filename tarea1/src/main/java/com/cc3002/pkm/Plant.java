 ...
 * Pokemon Plant Type.
 */
public class Plant extends AbstractPokemon {
   ...
   * @param life the life
   */
  public Plant(final String name, final double damage, 
      final double life) {
  ...
  public void attack(final Pokemon attacked) {
    if (!this.getObjectLife().isDead()) {
      attacked.battleWithPlantType(this); 
    }
  }

  /**
   * This method is called when a plant-type
   * pokemon attack a plant-type pokemon.
   * 
   ...
   */
  public void battleWithAguaType(final Aqua aqua) {
    Battle.ineffective(this, aqua);
  }
