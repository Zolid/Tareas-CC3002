...
/**
 * The Class Psychic, is the class to set a new
 * Pokemon Psychic Type.
 */
public class Psychic extends AbstractPokemon {

  /**
   * Instantiates a new psychic.
   *
   * @param name the name
   * @param damage the damage
   * @param life the life
   */
  public Psychic(final String name, final double damage, 
      final double life) {
  ...
  public void attack(final Pokemon attacked) {
    if (!this.getObjectLife().isDead()) {
      attacked.battleWithPsychicType(this);
    }
  }

  /**
   * This method is called when a plant-type
   * pokemon attack a psychic-type pokemon.
   * 
   ...
   * pokemon attack a psyshic-type pokemon.
   * 
