...
public class FireTest {
  ...
  public void setUp() throws Exception {
    pkm1 = new Fire("fire", 100.0, 1000.0);
    pkm2 = new Plant("plant", 100.0, 1000.0);
    ...
    pkm9 = new Fire("fire2", 100.0, 1000.0);
  }
  
  @Test
  public void namePokemonTest() {
    assertEquals("Check pokemon's name", pkm1.getName(), "fire");
  }

  @Test
  public void vsFire() {
    pkm1.attack(pkm9);
    assertEquals("check damage fire to fire", 100.0,
  ...
  public void vsPlant() {
    pkm1.attack(pkm2);
    assertEquals("check damage fire to plant", 200.0,
  ...
  public void vsAqua() {
    pkm1.attack(pkm3);
    assertEquals("check damage fire to aqua", 80.0,
  ...
  public void vsElectric() {
    pkm1.attack(pkm4);
    assertEquals("check damage fire to electric", 100.0,
  ...
  public void vsEarth() {
    pkm1.attack(pkm5);
    assertEquals("check damage fire to earth", 100.0,
  ...
  public void vsPsychic() {
    pkm1.attack(pkm6);
    assertEquals("check damage fire to psychic", 100.0,
  ...
  public void vsFight() {
    pkm1.attack(pkm7);
    assertEquals("check damage fire to fight", 100.0,
  ...
  public void vsNormal() {
    pkm1.attack(pkm8);
    assertEquals("check damage fire to normal", 100.0,
