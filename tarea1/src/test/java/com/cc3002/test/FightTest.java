...
public class FightTest {
  ...
  public void setUp() throws Exception {
    pkm1 = new Fight("fight", 100.0, 1000.0);
    ...
    pkm7 = new Plant("plant", 100.0, 1000.0);
    pkm8 = new Normal("Normal", 100.0, 1000.0);
    pkm9 = new Fight("fight2", 100.0, 1000.0);
  }

  @Test
  public void vsFight() {
    pkm1.attack(pkm9);
    assertEquals("check damage fight to fight", 100.0,
  ...
  public void vsFire() {
    pkm1.attack(pkm2);
    assertEquals("check damage fight to fire", 100.0,
  ...
  public void vsAqua() {
    pkm1.attack(pkm3);
    assertEquals("check damage fight to aqua", 100.0,
  ...
  public void vsElectric() {
    pkm1.attack(pkm4);
    assertEquals("check damage plant to electric", 100.0,
  ...
  public void vsEarth() {
    pkm1.attack(pkm5);
    assertEquals("check damage fight to earth", 100.0,
  ...
  public void vsPsychic() {
    pkm1.attack(pkm6);
    assertEquals("check damage fight to psychic", 100.0,
  ...
  public void vsPlant() {
    pkm1.attack(pkm7);
    assertEquals("check damage fight to plant", 100.0,
  ...
  public void vsNormal() {
    pkm1.attack(pkm8);
    assertEquals("check damage fight to normal", 200.0,
        pkm8.getObjectLife().getDamage(), 200.0);
  }
