...
public class PsychicTest {
  ...
  public void setUp() throws Exception {
    pkm1 = new Psychic("pyschic", 100.0, 1000.0);
    pkm2 = new Fire("fire", 100.0, 1000.0);
    pkm3 = new Aqua("agua", 100.0, 1000.0);
    pkm4 = new Electric("electric", 100.0, 1000.0);
    pkm5 = new Earth("earth", 100.0, 1000.0);
    pkm6 = new Plant("plant", 100.0, 1000.0);
    pkm7 = new Fight("fight", 100.0, 1000.0);
    pkm8 = new Normal("Normal", 100.0, 1000.0);
    pkm9 = new Psychic("psychic2", 100.0, 1000.0);
  }

  @Test
  public void vsPsychic() {
    pkm1.attack(pkm9);
    assertEquals("check damage psychic to psychic", 200.0,
        pkm9.getObjectLife().getDamage(), 200.0);
  }
  
  @Test
  public void vsFire() {
    pkm1.attack(pkm2);
    assertEquals("check damage psychic to fire", 100.0,
        pkm2.getObjectLife().getDamage(), 100.0);
  }
  
  @Test
  public void vsAqua() {
    pkm1.attack(pkm3);
    assertEquals("check damage psychic to aqua", 100.0,
        pkm3.getObjectLife().getDamage(), 100.0);
  }
  ...
  public void vsElectric() {
    pkm1.attack(pkm4);
    assertEquals("check damage pychic to electric", 100.0,
  ...
  public void vsEarth() {
    pkm1.attack(pkm5);
    assertEquals("check damage plant to earth", 100.0,
  ...
  public void vsPlant() {
    pkm1.attack(pkm6);
    assertEquals("check damage psychic to plant", 100.0,
  ...
  public void vsFight() {
    pkm1.attack(pkm7);
    assertEquals("check damage plant to fight", 200.0,
        pkm7.getObjectLife().getDamage(), 200.0);
  }
  
  @Test
  public void vsNormal() {
    pkm1.attack(pkm8);
    assertEquals("check damage plant to normal", 100.0,
