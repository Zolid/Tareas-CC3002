...
public class ElectricTest {
  ...
  public void setUp() throws Exception {
    pkm1 = new Electric("electric", 100.0, 1000.0);
    pkm2 = new Fire("fire", 100.0, 1000.0);
    pkm3 = new Aqua("agua", 100.0, 1000.0);
    pkm4 = new Plant("plant", 100.0, 1000.0);
    ...
    pkm9 = new Electric("electric2", 100.0, 1000.0);
  }

  @Test
  public void vsElectric() {
    pkm1.attack(pkm9);
    assertEquals("check damage electric to electric", 80.0,
        pkm9.getObjectLife().getDamage(), 80.0);
  }
  
  @Test
  public void vsFire() {
    pkm1.attack(pkm2);
    assertEquals("check damage electric to fire", 100.0,
  ...
  public void vsAqua() {
    pkm1.attack(pkm3);
    assertEquals("check damage plant to aqua", 200.0,
  ...
  public void vsPlant() {
    pkm1.attack(pkm4);
    assertEquals("check damage electric to plant", 100.0,
  ...
  public void vsEarth() {
    pkm1.attack(pkm5);
    assertEquals("check damage electric to earth", 80.0,
  ...
  public void vsPsychic() {
    pkm1.attack(pkm6);
    assertEquals("check damage electric to psychic", 100.0,
  ...
  public void vsFight() {
    pkm1.attack(pkm7);
    assertEquals("check damage electric to fight", 100.0,
  ...
  public void vsNormal() {
    pkm1.attack(pkm8);
    assertEquals("check damage electric to normal", 100.0,
