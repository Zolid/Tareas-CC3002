...
public class PlantTest {
  ...
  public void setUp() throws Exception {
    pkm1 = new Plant("plant", 100.0, 1000.0);
    ...
    pkm9 = new Plant("plant2", 100.0, 1000.0);
  }

  @Test
  public void vsPlant() {
    pkm1.attack(pkm9);
    assertEquals("check damage plant to plant", 100.0,
  ...
  public void vsFire() {
    pkm1.attack(pkm2);
    assertEquals("check damage plant to fire", 80.0,
  ...
  public void vsEarth() {
    pkm1.attack(pkm5);
    assertEquals("check damage plant to earth", 200.0,
        pkm5.getObjectLife().getDamage(), 200.0);
  }
  
  @Test
  public void vsPsychic() {
    pkm1.attack(pkm6);
    assertEquals("check damage plant to psychic", 100.0,
  ...
  public void vsFight() {
    pkm1.attack(pkm7);
    assertEquals("check damage plant to fight", 100.0,
