...
public class NormalTest {
  ...
  public void setUp() throws Exception {
    pkm1 = new Normal("normal", 100.0, 1000.0);
    ...
    pkm8 = new Plant("plant", 100.0, 1000.0);
    pkm9 = new Normal("normal2", 100.0, 1000.0);
  }

  @Test
  public void vsNormal() {
    pkm1.attack(pkm9);
    assertEquals("check damage normal to normal", 100.0,
  ...
  public void vsFire() {
    pkm1.attack(pkm2);
    assertEquals("check damage normal to fire", 100.0,
  ...
  public void vsAqua() {
    pkm1.attack(pkm3);
    assertEquals("check damage normal to aqua", 100.0,
  ...
  public void vsElectric() {
    pkm1.attack(pkm4);
    assertEquals("check damage normal to electric", 100.0,
  ...
  public void vsEarth() {
    pkm1.attack(pkm5);
    assertEquals("check damage normal to earth", 80.0,
  ...
  public void vsPsychic() {
    pkm1.attack(pkm6);
    assertEquals("check damage normal to psychic", 100.0,
  ...
  public void vsFight() {
    pkm1.attack(pkm7);
    assertEquals("check damage normal to fight", 100.0,
  ...
  public void vsPlant() {
    pkm1.attack(pkm8);
    assertEquals("check damage normal to plant", 100.0,
