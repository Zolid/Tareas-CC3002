...
public class EarthTest {
  ...
  public void vsFire() {
    pkm1.attack(pkm2);
    assertEquals("check damage earth to fire", 200.0,
  ...
  public void vsAqua() {
    pkm1.attack(pkm3);
    assertEquals("check damage earth to aqua", 100.0,
  ...
  public void vsElectric() {
    pkm1.attack(pkm4);
    assertEquals("check damage earth to electric", 200.0,
        pkm4.getObjectLife().getDamage(), 200.0);
  }
  ...
  public void vsPlant() {
    pkm1.attack(pkm5);
    assertEquals("check damage earth to plant", 80.0,
        pkm5.getObjectLife().getDamage(), 80.0);
  }
  
  @Test
  public void vsPsychic() {
    pkm1.attack(pkm6);
    assertEquals("check damage earth to psychic", 100.0,
  ...
  public void vsFight() {
    pkm1.attack(pkm7);
    assertEquals("check damage earth to fight", 80.0,
        pkm7.getObjectLife().getDamage(), 80.0);
  }
  
  @Test
  public void vsNormal() {
    pkm1.attack(pkm8);
    assertEquals("check damage earth to normal", 100.0,
